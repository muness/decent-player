...
/**
 * Persisted display preferences for the Recently Played panel (layout mode),
...
object RecentlyPlayedPreferences {
    ...
    const val GRID_SIZE_PORTRAIT = "recently_played_grid_size_portrait1"
    const val GRID_SIZE_LANDSCAPE = "recently_played_grid_size_landscape1"
